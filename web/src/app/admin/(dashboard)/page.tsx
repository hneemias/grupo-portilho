...
export default async function AdminDashboard() {
    ...
    return (
        <div className="animate-fade-in-up mt-8">
            <h1 className="text-4xl font-plus-jakarta font-medium text-white mb-2">Painel de <strong className="font-black text-[#a3e635]">Gestão</strong></h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#0b2545] border border-[#a3e635]/20 rounded-3xl p-8 shadow-2xl flex flex-col justify-between hover:scale-[1.02] transition-all relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <Mail className="w-20 h-20 text-[#a3e635]" />
                    </div>
                    ...
                    <Link href="/admin/mensagens" className="w-full py-4 bg-[#a3e635] text-[#051c36] text-center font-black rounded-xl relative z-10">Ver Mensagens</Link>
                </div>
                ...
                <div className="bg-[#051c36] border border-white/5 rounded-3xl p-8 shadow-2xl flex flex-col justify-between hover:border-[#a3e635]/20 transition-colors">
                    ...
                    <Link href="/admin/kpis" className="w-full py-4 bg-[#a3e635] text-[#051c36] text-center font-bold rounded-xl hover:scale-[1.02] transition-transform">Gerenciar Métricas</Link>
                </div>
                ...
                <div className="bg-[#051c36] border border-white/5 rounded-3xl p-8 shadow-2xl flex flex-col justify-between hover:border-[#a3e635]/20 transition-colors">
                    ...
                    <Link href="/admin/mapa" className="w-full py-4 bg-[#a3e635] text-[#051c36] text-center font-bold rounded-xl hover:scale-[1.02] transition-transform">Gerenciar Mapa</Link>
                </div>
