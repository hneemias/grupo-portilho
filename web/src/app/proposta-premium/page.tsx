...
export default function PropostaPremium() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#ffffff] font-inter overflow-x-hidden">
      ...
      {/* HEADER DA PROPOSTA */}
      <section className="relative w-full bg-[#051c36] py-20 px-8 lg:px-16 text-white overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#a3e635] opacity-[0.05] blur-[120px] rounded-full" />
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="bg-[#a3e635]/10 text-[#a3e635] px-4 py-1.5 rounded-full font-bold text-sm tracking-widest uppercase border border-[#a3e635]/20 mb-6 inline-block">
          ...
          <h1 className="text-5xl lg:text-7xl font-plus-jakarta font-black leading-tight">
            ...
            <span className="text-[#a3e635]">Digital do Grupo</span>
          </h1>
      ...
      <section className="w-full bg-[#f8f6f0] py-28 px-8 lg:px-16 relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col mb-16">
            <h2 className="text-4xl lg:text-5xl font-plus-jakarta font-black text-[#051c36] mb-4">
              Uma Jornada de <span className="text-[#6b7054]">25 Anos</span>
            </h2>
            <p className="text-[#051c36]/60 font-medium max-w-xl">Desde a consultoria inicial em 1999 até a liderança no Tocantins em 2016, a trajetória do Grupo Portilho é marcada por aprendizado contínuo.</p>
          </div>
          ...
          <div className="relative flex flex-col gap-8">
            ...
            {[
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-[#051c36] text-[#a3e635] flex items-center justify-center flex-shrink-0 z-10 shadow-lg group-hover:scale-110 transition-transform">
                  {step.icon}
                </div>
                <div>
                  <span className="text-[#a3e635] font-black text-2xl mb-1 block">{step.year}</span>
                  <h3 className="text-xl font-bold text-[#051c36] mb-2">{step.title}</h3>
                  <p className="text-[#051c36]/70 font-medium">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="w-full bg-[#051c36] py-28 px-8 lg:px-16 overflow-hidden relative">
        <div className="absolute -bottom-20 -left-20 w-[400px] h-[400px] bg-[#a3e635] opacity-[0.03] blur-[100px] rounded-full" />
        
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1">
            <span className="text-[#a3e635] font-bold tracking-widest uppercase text-xs mb-4 block">Modelo de Produção</span>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4 group">
                  <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#a3e635] group-hover:bg-[#a3e635] group-hover:text-[#051c36] transition-all duration-300">
                    {item.icon}
                  </div>
                  <div>
          ...
          <div className="flex-1 w-full h-[500px] bg-gradient-to-br from-[#1b2c4d] to-[#01142e] rounded-[3rem] p-12 border border-white/10 relative shadow-2xl flex flex-col justify-center items-center text-center overflow-hidden">
             ...
             <h3 className="text-[#a3e635] text-5xl font-black mb-4">25.000</h3>
             ...
             <div className="mt-8 grid grid-cols-2 gap-4 w-full">
                ...
                <div className="bg-[#a3e635]/10 p-6 rounded-2xl border border-[#a3e635]/20">
                  <span className="text-[#a3e635]/60 text-[10px] uppercase font-black block mb-2">2ª Safra</span>
                  <span className="text-[#a3e635] text-xl font-bold">Custo Zero</span>
                </div>
             </div>
          </div>
        </div>
      ...
      <section className="w-full bg-white py-28 px-8 lg:px-16">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <div className="inline-flex items-center gap-2 bg-[#051c36]/5 px-4 py-2 rounded-full text-[#051c36] font-bold text-xs uppercase tracking-widest mb-6">
            <Cpu className="w-4 h-4" /> Visão Tecnológica
          </div>
          <h2 className="text-4xl lg:text-5xl font-plus-jakarta font-black text-[#051c36]">O Amanhã é <span className="text-[#6b7054]">Data-Driven</span></h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card Algodoeira */}
          <div className="group relative bg-[#f8f6f0] rounded-[2.5rem] p-10 overflow-hidden border border-black/5 hover:border-[#a3e635]/30 transition-all duration-500">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-[#051c36] mb-6">Nova Unidade Algodoeira (Gurupi-TO)</h3>
              <p className="text-[#051c36]/70 leading-relaxed mb-8">Processamento verticalizado com tecnologia de ponta para classificação de fibras (resistência, comprimento e resiliência).</p>
              <div className="flex items-center gap-3 text-[#051c36] font-black uppercase text-xs tracking-widest group-hover:gap-5 transition-all">
          ...
          <div className="group relative bg-[#051c36] rounded-[2.5rem] p-10 overflow-hidden text-white transition-all duration-500 hover:shadow-2xl">
            ...
            <div className="relative z-10">
              <span className="text-[#a3e635] font-black text-sm uppercase mb-4 block">Inovação</span>
              ...
              <div className="flex items-center gap-3 text-[#a3e635] font-black uppercase text-xs tracking-widest group-hover:gap-5 transition-all">
      ...
      <footer className="w-full bg-[#f8f6f0] py-12 px-8 text-center border-t border-black/5">
        <p className="text-[#051c36]/40 font-bold uppercase tracking-widest text-[10px]">
